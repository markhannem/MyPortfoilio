...
# Inputs with some validations and Outside Loop
while True:
    while True:
    ...
    while True:
        ...
        if PosCode == "":
            ...
            print("Province must be 7 characters please - re-enter.")
        else:
            break
    while True:
    ...
    CCExp = input("Enter the customers credit card expiry date  : ")
